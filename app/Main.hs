...
import Compiler.Compiler(compileWithNamespace)
              ...
              case inferTypeWithMain program of
                ...
                Right program' -> do
                  case desugarProgram program' of
                    Left e -> die e
                    Right termC ->
                      case compileWithNamespace namespace termC of
                        Left e -> die e
...
usage = do
  ...
  putStrLn "  nuflo -c foo.nu       Compile program to abstract machine code."
